...
import com.jian.annotation.OperationLogger;
...
import com.jian.util.PictureUtil;
...
//		commentService.deleteCommentsByBlogId(id);
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody com.jian.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody com.jian.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(com.jian.model.dto.Blog blog, String type) {
		//验证普通字段
